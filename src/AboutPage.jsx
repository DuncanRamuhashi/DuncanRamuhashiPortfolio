...
function AboutPage(){
    ...
    return( 
      ...
      <div className="text-center space-y-14 bg-black p-8  rounded shadow-lg w-full max-w-5xl">
        <div className="mb-2">
          <h1 className="pt-14 text-blue-700 text-4xl font-bold font-mono justify-center">About Me</h1>

          <div className="text-center md:text-justify shadow p-6 md:p-12 bg-black text-justify">
            <h1 className="text-sm text-zinc-400 px-4">
              Greetings! I am a dedicated Full Stack Developer. My expertise lies in technologies, including HTML, CSS, and JavaScript. Currently, I'm deeply engaged with React, Next.js, and Typescript. I maintain a perpetual commitment to honing my skills and keeping pace with the ever-evolving landscape of industry trends.
            </h1>
            ...
            <div className="p-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <h1 className="text-stone-100">University of Johannesburg</h1>
              </div>
              <div>
  ...
  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-10 gap-4  md:p-40 items-center justify-center p-24 ">
    <a href="https://dev.mysql.com/doc/" target="_blank">
      <img src={iSql} alt="sql" className="h-14 w-14 object-fill" />
    </a>
    <a href="https://react.dev/" target="_blank">
      <img src={iReact} alt="react" className="h-14 w-14 object-fill" />
    </a>
    <a href="https://docs.oracle.com/en/java" target="_blank">
      <img src={iJava} alt="java" className="h-14 w-14 object-fill" />
    </a>
    <a href="https://www.w3schools.com/html/html_intro.asp" target="_blank">
      <img src={iHtml} alt="Html" className="h-14 w-14 object-fill" />
    </a>
    <a href="https://developer.mozilla.org/en-US/docs/Web/CSS" target="_blank">
      <img src={iCss} alt="Css" className="h-14 w-14 object-fill" />
    </a>
    <a href="https://learn.microsoft.com/en-us/dotnet/csharp/" target="_blank">
      <img src={iCshap} alt="Cshap" className="h-14 w-14 object-fill" />
    </a>
    <a href="https://learn.microsoft.com/en-us/dotnet/" target="_blank">
      <img src={iDot} alt="net" className="h-14 w-14 object-fill" />
    </a>
    <a href="https://learn.microsoft.com/en-us/dotnet/maui/?view=net-maui-8.0" target="_blank">
      <img src={iMobile} alt="mobile" className="h-14 w-14 object-fill" />
    </a>
    <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript" target="_blank">
      <img src={iJS} alt="js" className="h-14 w-14 object-fill" />
    </a>
    <a href="https://docs.oracle.com/cd/E19253-01/817-5477/817-5477.pdf" target="_blank">
      <img src={iAsse} alt="Assemblyx86" className="h-14 w-14 object-fill" />
    </a>
  </div>
</div>
